...
Commit title format: `<type>[optional scope]: <short imperative description>`

Types: `feat`, `fix`, `docs`, `refactor`, `test`, `chore`

Scopes: `monitor`, `processors`, `config`, `cli`, `daemon`, `logging`, `deps`, `ci`
